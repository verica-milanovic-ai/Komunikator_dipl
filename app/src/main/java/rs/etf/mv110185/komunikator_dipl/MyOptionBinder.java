...
import rs.etf.mv110185.komunikator_dipl.listeners.DeleteOnClickListener;
...
public class MyOptionBinder implements SimpleCursorAdapter.ViewBinder {
    ...
    public boolean setViewValue(View view, Cursor cursor,
        ...
        if (view.getId() == R.id.imageButton) {
            ...
            ImageButton ib = (ImageButton) view;
            if (CommunicatorController.IS_ADMIN == 0) {
                ib.setVisibility(View.GONE);
            } else {
                ib.setVisibility(View.VISIBLE);
                ib.setTag(DBHelper.fillOption(cursor));
                ib.setOnClickListener(new DeleteOnClickListener());
            }
        }
        return false;
    }
